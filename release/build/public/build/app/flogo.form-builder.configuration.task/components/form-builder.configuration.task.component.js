...
var fields_listbox_component_1 = require('../../flogo.form-builder.fields/components/fields.listbox/fields.listbox.component');
...
var FlogoFormBuilderConfigurationTaskComponent = (function () {
    ...
    FlogoFormBuilderConfigurationTaskComponent.prototype.getControlByType = function (item) {
        if (item.allowed) {
    ...
    FlogoFormBuilderConfigurationTaskComponent = __decorate([
        core_1.Component({
            ...
            moduleId: module.id,
            template: "<div>    <div class=\"flogo-common-edit-panel__container\">     <h3 class=\"flogo-common-edit-panel__legend\" [hidden]=\"!fields.inputs.length\">Input</h3>     <div *ngFor=\"let item of fields.inputs; #index = index\" class=\"\">        <div *ngIf=\"getControlByType(item).control == 'FieldTextBox'\">         <flogo-form-builder-fields-textbox [info]=\"getTaskInfo(item, 'input','inputs')\" [fieldObserver]=\"_fieldObserver\" ></flogo-form-builder-fields-textbox>       </div>        <div *ngIf=\"getControlByType(item).control == 'FieldListBox'\">         <flogo-form-builder-fields-listbox [info]=\"getTaskInfo(item, 'input','inputs')\" [fieldObserver]=\"_fieldObserver\" ></flogo-form-builder-fields-listbox>       </div>        <div *ngIf=\"getControlByType(item).control == 'FieldNumber'\">         <flogo-form-builder-fields-number [info]=\"getTaskInfo(item, 'input','inputs')\" [fieldObserver]=\"_fieldObserver\" ></flogo-form-builder-fields-number>       </div>        <div *ngIf=\"getControlByType(item).control == 'FieldRadio'\">         <flogo-form-builder-fields-radio [info]=\"getTaskInfo(item, 'input','inputs')\" [fieldObserver]=\"_fieldObserver\" [index]=\"index\" ></flogo-form-builder-fields-radio>       </div>        <div *ngIf=\"getControlByType(item).control == 'FieldTextArea'\">         <flogo-form-builder-fields-textarea [info]=\"getTaskInfo(item, 'input','inputs')\" [fieldObserver]=\"_fieldObserver\" ></flogo-form-builder-fields-textarea>       </div>         <div *ngIf=\"getControlByType(item).control == 'FieldObject'\">         <flogo-form-builder-fields-object [info]=\"getTaskInfo(item, 'input','inputs')\" [fieldObserver]=\"_fieldObserver\" ></flogo-form-builder-fields-object>       </div>      </div>      <h3 class=\"flogo-common-edit-panel__legend\" [hidden]=\"!fields.outputs.length\">Output</h3>     <div *ngFor=\"let item of fields.outputs\" class=\"flogo-task-container__output\">        <div *ngIf=\"getControlByType(item).control == 'FieldTextBox'\">         <flogo-form-builder-fields-textbox [info]=\"getTaskInfo(item, 'output','outputs')\" [fieldObserver]=\"_fieldObserver\" ></flogo-form-builder-fields-textbox>       </div>        <div *ngIf=\"getControlByType(item).control == 'FieldListBox'\">         <flogo-form-builder-fields-listbox [info]=\"getTaskInfo(item, 'output','outputs')\" [fieldObserver]=\"_fieldObserver\" ></flogo-form-builder-fields-listbox>       </div>        <div *ngIf=\"getControlByType(item).control == 'FieldNumber'\">         <flogo-form-builder-fields-number [info]=\"getTaskInfo(item, 'output','outputs')\" [fieldObserver]=\"_fieldObserver\" ></flogo-form-builder-fields-number>       </div>        <div *ngIf=\"getControlByType(item).control == 'FieldRadio'\">         <flogo-form-builder-fields-radio [info]=\"getTaskInfo(item, 'output','outputs')\" [fieldObserver]=\"_fieldObserver\" ></flogo-form-builder-fields-radio>       </div>        <div *ngIf=\"getControlByType(item).control == 'FieldTextArea'\">         <flogo-form-builder-fields-textarea [info]=\"getTaskInfo(item, 'output','outputs')\" [fieldObserver]=\"_fieldObserver\"  ></flogo-form-builder-fields-textarea>       </div>        <div *ngIf=\"getControlByType(item).control == 'FieldObject'\">         <flogo-form-builder-fields-object [info]=\"getTaskInfo(item, 'output','outputs')\" [fieldObserver]=\"_fieldObserver\"  ></flogo-form-builder-fields-object>       </div>      </div>   </div>    </div>",
            directives: [fields_radio_component_1.FlogoFormBuilderFieldsRadio, fields_textbox_component_1.FlogoFormBuilderFieldsTextBox, fields_textarea_component_1.FlogoFormBuilderFieldsTextArea, fields_number_component_1.FlogoFormBuilderFieldsNumber, fields_object_component_1.FlogoFormBuilderFieldsObject, fields_listbox_component_1.FlogoFormBuilderFieldsListBox],
