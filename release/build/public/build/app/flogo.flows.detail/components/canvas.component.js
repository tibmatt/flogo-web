...
var FlogoCanvasComponent = (function () {
    ...
    FlogoCanvasComponent.prototype.exportFlow = function () {
        return this._exportFlow.bind(this);
    };
    FlogoCanvasComponent.prototype._exportFlow = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            resolve(flow_model_1.flogoFlowToJSON(_this._flow));
        });
    };
