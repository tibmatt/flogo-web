FROM desertbit/golang-gb:1.6-alpine

VOLUME "./docker-shared"

#INSTALL FLOGO ENGINE
...
RUN apk add --no-cache curl make gcc g++ python linux-headers paxctl libgcc libstdc++ gnupg ca-certificates && \
