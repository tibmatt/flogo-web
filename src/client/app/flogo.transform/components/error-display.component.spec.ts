...
describe('Component: ErrorDisplayComponent', () => {
  ...
  let comp: ErrorDisplayComponent;
  ...
  it('Shows the errors block only when there are any errors', () => {
      const res: Array<DebugElement> = fixture.debugElement.queryAll(By.css('.transform-error-wrapper'));
  ...
  it('Show error for invalid transform mappings - invalid JSON', () => {
        ...
        const res: DebugElement = fixture.debugElement.query(By.css('.transform-error-msg'));
  ...
  it('Show 2 errors', () => {
        ...
        fixture.detectChanges();
        const res: Array<DebugElement> = fixture.debugElement.queryAll(By.css('.transform-error-msg'));
