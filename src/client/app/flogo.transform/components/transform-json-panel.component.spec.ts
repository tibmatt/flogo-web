...
describe('Component: TransformJsonPanelComponent', () => {
  ...
  const mockInputSchema = '<div class="ft-json__selected" style="margin-left:-15px;">[</div><div class="ft-json__selected" style="margin-left:10px;">{</div><div class="ft-json__selected" style="margin-left:20px;">"name":"method"</div><div class="ft-json__selected" style="margin-left:20px;">"type":"string"</div><div class="ft-json__selected" style="margin-left:10px;">},</div><div class="ft-json__selected" style="margin-left:10px;">{</div><div class="ft-json__selected" style="margin-left:20px;">"name":"pinNumber"</div><div class="ft-json__selected" style="margin-left:20px;">"type":"integer"</div><div class="ft-json__selected" style="margin-left:10px;">},</div><div class="ft-json__selected" style="margin-left:10px;">{</div><div class="ft-json__selected" style="margin-left:20px;">"name":"direction"</div><div class="ft-json__selected" style="margin-left:20px;">"type":"string"</div><div class="ft-json__selected" style="margin-left:10px;">},</div><div class="ft-json__selected" style="margin-left:10px;">{</div><div class="ft-json__selected" style="margin-left:20px;">"name":"state"</div><div class="ft-json__selected" style="margin-left:20px;">"type":"string"</div><div class="ft-json__selected" style="margin-left:10px;">},</div><div class="ft-json__selected" style="margin-left:10px;">{</div><div class="ft-json__selected" style="margin-left:20px;">"name":"Pull"</div><div class="ft-json__selected" style="margin-left:20px;">"type":"string"</div><div class="ft-json__selected" style="margin-left:10px;">}</div><div class="ft-json__selected" style="margin-left:-15px;">]</div>';
  // tslint:disable-next-line:max-line-length
  const mockOutputSchema = '<div class="ft-json__selected" style="margin-left:-10px;">{</div><div class="ft-json__selected" style="">"receive-http-message":[</div><div class="ft-json__selected" style="margin-left:5px;">{</div><div class="ft-json__selected" style="margin-left:10px;">"name":"pathParams"</div><div class="ft-json__selected" style="margin-left:10px;">"type":"params"</div><div class="ft-json__selected" style="margin-left:5px;">},</div><div class="ft-json__selected" style="margin-left:5px;">{</div><div class="ft-json__selected" style="margin-left:10px;">"name":"queryParams"</div><div class="ft-json__selected" style="margin-left:10px;">"type":"params"</div><div class="ft-json__selected" style="margin-left:5px;">},</div><div class="ft-json__selected" style="margin-left:5px;">{</div><div class="ft-json__selected" style="margin-left:10px;">"name":"content"</div><div class="ft-json__selected" style="margin-left:10px;">"type":"object"</div><div class="ft-json__selected" style="margin-left:5px;">}</div><div class="ft-json__selected" style="">]</div><div class="ft-json__selected" style="">"received":[</div><div class="ft-json__selected" style="margin-left:5px;">{</div><div class="ft-json__selected" style="margin-left:10px;">"name":"message"</div><div class="ft-json__selected" style="margin-left:10px;">"type":"string"</div><div class="ft-json__selected" style="margin-left:5px;">}</div><div class="ft-json__selected" style="">]</div><div class="ft-json__selected" style="">"set-to-output":[</div><div class="ft-json__selected" style="margin-left:5px;">{</div><div class="ft-json__selected" style="margin-left:10px;">"name":"result"</div><div class="ft-json__selected" style="margin-left:10px;">"type":"integer"</div><div class="ft-json__selected" style="margin-left:5px;">}</div><div class="ft-json__selected" style="">]</div><div class="ft-json__selected" style="margin-left:-15px;">}</div>';
  let comp: TransformJsonPanelComponent;
  let fixture: ComponentFixture<TransformJsonPanelComponent>;
  ...
  it('Shows the block in collapsed state when instantiated', () => {
    const res: Array<DebugElement> = fixture.debugElement
  ...
  it('Input JSON mapping is formed as per the given input schema', () => {
    comp.togglePanel();
    fixture.detectChanges();
    const res: DebugElement = fixture.debugElement.query(By.css('.flogo-transformation-json__code'));
  ...
  it('togglePanel method toggles the JSON mappings of JSON panel', () => {
    comp.togglePanel();
    fixture.detectChanges();
    const res: Array<DebugElement> = fixture.debugElement.queryAll(By.css('.flogo-transformation-json__code'));
    expect(res.length).toBe(1);
  });
});
