...
function traversalDiagram( diagram: IFlogoDiagram, tasks: IFlogoTaskDictionary, tasksDest: IFlogoTask[ ], linksDest: IFlogoTaskLink[ ] ): void {
...
function _traversalChildren( node: IFlogoNode, visitedNodes: string[ ], nodes: IFlogoNodeDictionary, tasks: IFlogoTaskDictionary, tasksDest: IFlogoTask[ ], linksDest: IFlogoTaskLink[ ] ) {
