  ...
  private registerCompletionProvider() {
    ...
    const _provideCompletion = (model, position, cancellationToken) => {
      if (!this.completionProvider) {
        return [
          {
            label: 'string.concat(str1, str2, ...) : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.concat(str1, str2)'
          },
          {
            label: 'string.base64ToString(base64str) : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.base64ToString(base64str)'
          },
          {
            label: 'string.contains(str, substr) : bool',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.contains(str, substr)'
          },
          {
            label: 'string.dateFormat() : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.dateFormat()'
          },
          {
            label: 'string.datetimeFormat() : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.datetimeFormat()'
          },
          {
            label: 'string.endsWith(str, substr) : bool',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.endsWith(str, substr)'
          },
          {
            label: 'string.index(str, substr) : int',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.index(str, substr)'
          },
          {
            label: 'string.lastIndex(str, substr) : int',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.lastIndex(str, substr)'
          },
          {
            label: 'string.lowerCase(str) : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.lowerCase(str)'
          },
          {
            label: 'string.regex(pattern, str) : bool',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.regex(pattern, str)'
          },
          {
            label: 'string.split(str, sep) : string[]',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.split(str, sep)'
          },
          {
            label: 'string.startsWith(str, substr) : bool',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.startsWith(str, substr)'
          },
          {
            label: 'string.length(str) : int',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.length(str)'
          },
          {
            label: 'string.stringToBase64(str) : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.stringToBase64(str)'
          },
          {
            label: 'string.substring(string, startIndex, length) : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.substring(string, startIndex, length)'
          },
          {
            label: 'string.substring(string, startIndex) : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.substring(string, startIndex)'
          },
          {
            label: 'string.substringAfter(string, afterString) : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.substringAfter(string, afterString)'
          },
          {
            label: 'string.substringBefore(string, beforeString) : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.substringBefore(string, beforeString)'
          },
          {
            label: 'string.timeFormat() : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.timeFormat()'
          },
          {
            label: 'string.tostring(object) : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.tostring(object)'
          },
          {
            label: 'string.trim(str): string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.trim(str)'
          },
          {
            label: 'string.upperCase(str) : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'string.upperCase(str)'
          },
          {
            label: 'number.int64(str) : int',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'number.int64(str)'
          },
          {
            label: 'number.len(str) : int',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'number.len(str)'
          },
          {
            label: 'number.random(limit) : int',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'number.random(limit)'
          },
          {
            label: 'boolean.true() : bool',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'boolean.true()'
          },
          {
            label: 'boolean.false() : bool',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'boolean.false()'
          },
          {
            label: 'datetime.currentDate() : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'datetime.currentDate()'
          },
          {
            label: 'datetime.currentDatetime() : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'datetime.currentDatetime()'
          },
          {
            label: 'datetime.currentTime() : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'datetime.currentTime()'
          },
          {
            label: 'datetime.formatDate(date, dateFormat) : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'datetime.formatDate(date, dateFormat)'
          },
          {
            label: 'datetime.formatDatetime(datetime, dateTimeFormat) : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'datetime.formatDatetime(datetime, dateTimeFormat)'
          },
          {
            label: 'datetime.formatTime(time, timeFormat) : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'datetime.formatTime(time, timeFormat)'
          },
          {
            label: 'datetime.now() : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'datetime.now()'
          },
          {
            label: 'array.create(item1, item2, item3, ...) : array[]',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'array.create(item1, item2, item3, ...)'
          },
          {
            label: 'array.contains(array, item) : bool',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'array.contains(array, item)'
          },
          {
            label: 'array.forEach(sourceArray) : void',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'array.forEach(sourceArray)'
          },
          {
            label: 'array.forEach() : void',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'array.forEach()'
          },
          {
            label: 'utility.renderJSON(object, prettyFormat) : string',
            kind: monaco.languages.CompletionItemKind.Function,
            insertText: 'utility.renderJSON(object, prettyFormat)'
          }
        ];
      }
