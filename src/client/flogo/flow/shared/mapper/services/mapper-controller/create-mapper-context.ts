import { AttributeDescriptor, MapperTranslator, StaticMapperContextFactory } from '../../utils';

export function createMapperContext(input: AttributeDescriptor[], output: any[], handlerMappings: any[]) {
