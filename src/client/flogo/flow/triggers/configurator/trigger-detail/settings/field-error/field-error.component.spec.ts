...
@Component({
  ...
  template: `<flogo-configuration-settings-field-error #component
              [validationErrors]="errors"></flogo-configuration-settings-field-error>`
})
...
describe('Component: FieldErrorComponent', () => {
  ...
  it('Should have 2 errors to show', () => {
    ...
    expect(fixture.debugElement.nativeElement.innerText)
      .toEqual('Property is required. Expression cannot be parsed, use $property[name] or $env[VAR_NAME].');
  });
  ...
  it('Should show proper message for ErrorTypes.SyntaxError', () => {
    ...
    fixture.detectChanges();
    expect(fixture.debugElement.nativeElement.innerText)
      .toEqual('Expression cannot be parsed, use $property[name] or $env[VAR_NAME].');
  });
  ...
  it('Should show proper message for ErrorTypes.MissingResolvableProperty property resolver', () => {
    ...
    fixture.detectChanges();
    expect(fixture.debugElement.nativeElement.innerText).toEqual('Missing property name, use: $property[propertyName].');
  });
});
