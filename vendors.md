...
| Name | Version | Home Page | License | Description |
| ---- | ------- | --------- | ------- | ----------- |
| @angular/common | 2.0.0-rc.1 | https://github.com/angular/angular#readme | MIT |  |
| @angular/compiler | 2.0.0-rc.1 | https://github.com/angular/angular#readme | MIT |  |
| @angular/core | 2.0.0-rc.1 | https://github.com/angular/angular#readme | MIT |  |
| @angular/http | 2.0.0-rc.1 | https://github.com/angular/angular#readme | MIT |  |
| @angular/platform-browser | 2.0.0-rc.1 | https://github.com/angular/angular#readme | MIT |  |
| @angular/platform-browser-dynamic | 2.0.0-rc.1 | https://github.com/angular/angular#readme | MIT |  |
| @angular/router | 2.0.0-rc.1 | https://github.com/angular/angular#readme | MIT |  |
| @angular/router-deprecated | 2.0.0-rc.1 | https://github.com/angular/angular#readme | MIT |  |
| bootstrap | ^3.3.6 | http://getbootstrap.com | MIT | The most popular front-end framework for developing responsive, mobile first projects on the web. |
| d3 | ^3.5.16 | http://d3js.org | BSD-3-Clause | A JavaScript visualization library for HTML and SVG. |
| es6-promise | ^3.0.2 | https://github.com/jakearchibald/ES6-Promises#readme | MIT | A lightweight library that provides tools for organizing asynchronous code |
| es6-shim | ^0.35.0 | https://github.com/paulmillr/es6-shim/ | MIT | ECMAScript 6 (Harmony) compatibility shims for legacy JavaScript engines |
| font-awesome | ^4.6.1 | http://fontawesome.io/ | (OFL-1.1 AND MIT) | The iconic font and CSS framework |
| jquery | ^2.2.2 | https://jquery.com | MIT | JavaScript library for DOM operations |
| lodash | ^4.6.1 | https://lodash.com/ | MIT | Lodash modular utilities. |
| moment | ^2.13.0 | http://momentjs.com | MIT | Parse, validate, manipulate, and display dates |
| ng2-bs3-modal | ^0.6.1 | https://github.com/dougludlow/ng2-bs3-modal#readme | ISC | Angular2 Boostrap3 Modal Component |
| postal | ^1.0.8 | http://github.com/postaljs/postal.js | [MIT](http://www.opensource.org/licenses/mit-license.php) | Pub/Sub library providing wildcard subscriptions, complex message handling, etc.  Works server and client-side. |
| pouchdb | 5.3.1 | https://github.com/pouchdb/pouchdb#readme | Apache-2.0 | PouchDB is a pocket-sized database |
| reflect-metadata | ^0.1.3 | http://rbuckton.github.io/ReflectDecorators | Apache-2.0 | Polyfill for Metadata Reflection API |
| rxjs | 5.0.0-beta.6 | https://github.com/ReactiveX/RxJS | Apache-2.0 | Reactive Extensions for modern JavaScript |
| systemjs | 0.19.27 | https://github.com/systemjs/systemjs#readme | MIT | Universal dynamic module loader |
| zone.js | ^0.6.12 | https://github.com/angular/zone.js#readme | MIT | Zones for JavaScript |

Server Production Dependencies

| Name | Version | Home Page | License | Description |
| ---- | ------- | --------- | ------- | ----------- |
| atob | ^2.0.3 | https://github.com/coolaj86/node-browser-compat | (MIT OR Apache-2.0) | atob for Node.JS and Linux / Mac / Windows CLI (it's a one-liner) |
| babel-cli | ^6.6.5 | https://babeljs.io/ | MIT | Babel command line. |
| babel-preset-es2015 | ^6.6.0 | https://babeljs.io/ | MIT | Babel preset for all es2015 plugins. |
| concurrently | ^2.0.0 | https://github.com/kimmobrunfeldt/concurrently | MIT | Run commands concurrently |
| fs-extra | ^0.30.0 | https://github.com/jprichardson/node-fs-extra | MIT | fs-extra contains methods that aren't included in the vanilla Node.js fs package. Such as mkdir -p, cp -r, and rm -rf. |
| koa | ^1.2.0 | https://github.com/koajs/koa#readme | MIT | Koa web app framework |
| koa-body | 1.4.0 | https://github.com/dlau/koa-body#readme | MIT | A koa body parser middleware. Support multipart, urlencoded and json request bodies. |
| koa-bodyparser | ^2.0.1 | https://github.com/koajs/body-parser | MIT | a body parser for koa |
| koa-compress | ^1.0.9 | https://github.com/koajs/compress#readme | MIT | Compress middleware for koa |
| koa-json | 1.1.3 | https://github.com/koajs/json#readme | MIT | pretty (non-compressed) json response middleware |
| koa-router | ^5.4.0 | https://github.com/alexmingoia/koa-router.git | MIT | Router middleware for koa. Provides RESTful resource routing. |
