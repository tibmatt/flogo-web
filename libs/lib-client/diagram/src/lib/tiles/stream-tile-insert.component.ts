...
@Component({
  selector: 'flogo-diagram-stream-tile-insert',
  templateUrl: './stream-tile-insert.component.html',
  styleUrls: ['./stream-tile-insert.component.less'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class StreamTileInsertComponent implements OnChanges {
