...
@Component({
  selector: 'flogo-diagram-stream-tile-task',
  templateUrl: './stream-tile-task.component.html',
  styleUrls: ['./stream-tile-task.component.less'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  animations: [trigger('menuOptions', OpenCloseMenuAnimation)],
})
export class StreamTileTaskComponent extends AbstractTileTaskComponent
